...
extern void init_enc28j60(uint8_t* macaddr);
//extern void init_enc28j60WithCs( uint8_t* macaddr, uint8_t csPin );
extern void enc28j60PacketSend(uint8_t* packet, uint16_t len);
extern uint16_t enc28j60PacketReceive(uint8_t* packet, uint16_t maxlen);
...
//extern void enc28j60EnableInterrupts( char *buf, uint16_t maxBufLength, void *DataHandlerFunction, void *ReconnectFunction );
//extern void enc28j60DisableInterrupts();
