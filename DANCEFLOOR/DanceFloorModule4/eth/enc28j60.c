...
//Chip Select Pin
#define ENC28J60_CONTROL_CS_PORT	PORTB
#define ENC28J60_CONTROL_CS_DDR		DDRB
#define ENC28J60_CONTROL_CS_PIN		2
//CLK Pin
#define ENC28J60_CONTROL_SCLK_PORT	PORTB
#define ENC28J60_CONTROL_SCLK_DDR	DDRB
#define ENC28J60_CONTROL_SCLK_PIN	5
//MOSI Pin
#define ENC28J60_CONTROL_MOSI_PORT	PORTB
#define ENC28J60_CONTROL_MOSI_DDR	DDRB
#define ENC28J60_CONTROL_MOSI_PIN	3
//MISO Pin
#define ENC28J60_CONTROL_MISO_PORT	PORTB
#define ENC28J60_CONTROL_MISO_DDR	DDRB
#define ENC28J60_CONTROL_MISO_PIN	4
//INTERRUPT Pin
#define ENC28J60_CONTROL_INT_PORT	PORTD
#define ENC28J60_CONTROL_INT_DDR	DDRD
#define ENC28J60_CONTROL_INT_PIN	3

// set CS to 0 = active
#define SELECT_ENC28J60 ENC28J60_CONTROL_CS_PORT&=~(1<<ENC28J60_CONTROL_CS_PIN)
// set CS to 1 = passive
#define DESELECT_ENC28J60 ENC28J60_CONTROL_CS_PORT|=(1<<ENC28J60_CONTROL_CS_PIN)


//SPI Initialization for internal use only
...
void init_enc28j60(uint8_t* macaddr)
{
	...
	// do bank 1 stuff, packet filter:
        ...
        // Type     ETH.DST														!!!!!!!!!!!!PATTERN MATCH IS OFF!!!!!!!!!!!!
        // ARP      BROADCAST
...
/*
static void enc28j60PhyWriteWord(byte address, uint16_t data) {
    enc28j60Write(MIREGADR, address);
...
/*
void enc28j60EnableInterrupts( char *flags )
{
	//encFlags = flags;
	
	//Enable ENCJ2860 (INT1) interrupt (falling edge)
	EICRA |= 0x08;  //Set   ISC11
	EICRA &= ~0x04; //Clear ISC10
	EIMSK |= 0x02;  //Enable INT1
	
	//Enable interrupts on the ENC28J60
	//INTIE interrupt enable
	//PKTIE interrupt
	enc28j60WriteOp(ENC28J60_BIT_FIELD_SET,EIE,INTIE|PKTIF);
	
}

void enc28j60DisableInterrupts()
{
	enc28j60WriteOp(ENC28J60_BIT_FIELD_CLR,EIE,INTIE|PKTIF);
}
